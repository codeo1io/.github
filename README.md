...
## Manual use
    ...
    python3 -m pytest tests/        # 77 tests: hermetic unit + control-plane mirror + deployed-artifact checks + gitleaks-config (7 of the latter are live-binary integrations, skipif-guarded)
