...
- id: `rm-019` | track: reliability | priority: 92.0 | status: candidate — URGENT (cycle-5 2026-09-23: signals inverted in reality; see below)
...
- id: `rm-042` | track: reliability | priority: 91.0 | status: candidate
...
- evidence: grep MANIFEST.sha256 lists both entrypoints; planted-diff check transcript exits nonzero; one live daily-run log line showing the verification executed
